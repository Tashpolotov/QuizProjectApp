    ...
    private fun initView(name: String) {
        ...
        adapter.setOnAnswerClickListener(object : QuestionsAdapter.OnAnswerClickListener {
            override fun onAnswerClick(selectedIndex: Int) {
                ...
                val currentQuestion = viewModel.programmer.value?.questionsJava?.get(currentQuestionIndex)
        ...
        binding.btnNext.setOnClickListener {
            val questions = viewModel.programmer.value?.questionsJava ?: emptyList()
        ...
        viewLifecycleOwner.lifecycleScope.launchWhenStarted {
            viewModel.programmer.collect { programmerModel ->
                val questions = programmerModel?.questionsJava ?: emptyList()
        ...
        viewModel.loadQuestionsJava(name)
